                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select name="reg_gender" class="custom-select">
                                            ...
                                            <option <?php if ($balancesheet['student_profile_gender'] == "Male") {
                                                      echo "selected";
                                                    } ?> value="Male">Male</option>
                                            <option <?php if ($balancesheet['student_profile_gender'] == "Female") {
                                                      echo "selected";
                                      ...
                                      <div class="col-md-3">
                                        <div class="form-group">
                                          ...
                                          <select name="reg_district" id="reg_district" class="custom-select">
                                            ...
                                            <option <?php if ($balancesheet['student_profile_district'] == "Chengleput") {
                                                      echo "selected";
                                                    } ?> value="Chengleput">Chengleput</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Chennai") {
                                                      echo "selected";
                                                    } ?> value="Chennai">Chennai</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Cuddalore") {
                                                      echo "selected";
                                                    } ?> value="Cuddalore">Cuddalore</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Dharmapuri") {
                                                      echo "selected";
                                                    } ?> value="Dharmapuri">Dharmapuri</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Kallakurichi") {
                                                      echo "selected";
                                                    } ?> value="Kallakurichi">Kallakurichi</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Kanchipuram") {
                                                      echo "selected";
                                                    } ?> value="Kanchipuram">Kanchipuram</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Krishnagiri") {
                                                      echo "selected";
                                                    } ?> value="Krishnagiri">Krishnagiri</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Namakkal") {
                                                      echo "selected";
                                                    } ?> value="Namakkal">Namakkal</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Puducherry") {
                                                      echo "selected";
                                                    } ?> value="Puducherry">Puducherry</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Ranipet") {
                                                      echo "selected";
                                                    } ?> value="Ranipet">Ranipet</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Salem") {
                                                      echo "selected";
                                                    } ?> value="Salem">Salem</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Thiruvallur") {
                                                      echo "selected";
                                                    } ?> value="Thiruvallur">Thiruvallur</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Tirupattur") {
                                                      echo "selected";
                                                    } ?> value="Tirupattur">Tirupattur</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Tiruvannamalai") {
                                                      echo "selected";
                                                    } ?> value="Tiruvannamalai">Tiruvannamalai</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Vellore") {
                                                      echo "selected";
                                                    } ?> value="Vellore">Vellore</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "Villupuram") {
                                                      echo "selected";
                                                    } ?> value="Villupuram">Villupuram</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "others-districts-tn") {
                                                      echo "selected";
                                                    } ?> value="others-districts-tn">Other Districts of Tamilnadu</option>
                                            <option <?php if ($balancesheet['student_profile_district'] == "others") {
                                                      echo "selected";
                                                    } ?> value="others">Other States Of India</option>
                                          </select>
                                        </div>
                                      </div>
                                      <div class="col-md-3">
                                        <div class="form-group">
                                          ...
                                          <select name="reg_state" id="reg_state" class="custom-select">
                                            ...
                                            <option <?php if ($balancesheet['student_profile_state'] == "Andaman & Nicobar") {
                                                      echo "selected";
                                                    } ?>>Andaman & Nicobar</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Andhra Pradesh") {
                                                      echo "selected";
                                                    } ?>>Andhra Pradesh</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Arunachal Pradesh") {
                                                      echo "selected";
                                                    } ?>>Arunachal Pradesh</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Assam") {
                                                      echo "selected";
                                                    } ?>>Assam</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Bihar") {
                                                      echo "selected";
                                                    } ?>>Bihar</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Chandigarh") {
                                                      echo "selected";
                                                    } ?>>Chandigarh</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Chhattisgarh") {
                                                      echo "selected";
                                                    } ?>>Chhattisgarh</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Dadra & Nagar Haveli") {
                                                      echo "selected";
                                                    } ?>>Dadra & Nagar Haveli</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Daman & Diu") {
                                                      echo "selected";
                                                    } ?>>Daman & Diu</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Delhi") {
                                                      echo "selected";
                                                    } ?>>Delhi</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Goa") {
                                                      echo "selected";
                                                    } ?>>Goa</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Gujarat") {
                                                      echo "selected";
                                                    } ?>>Gujarat</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Haryana") {
                                                      echo "selected";
                                                    } ?>>Haryana</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Himachal Pradesh") {
                                                      echo "selected";
                                                    } ?>>Himachal Pradesh</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Jammu & Kashmir") {
                                                      echo "selected";
                                                    } ?>>Jammu & Kashmir</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Jharkhand") {
                                                      echo "selected";
                                                    } ?>>Jharkhand</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Karnataka") {
                                                      echo "selected";
                                                    } ?>>Karnataka</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Kerala") {
                                                      echo "selected";
                                                    } ?>>Kerala</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Lakshadweep") {
                                                      echo "selected";
                                                    } ?>>Lakshadweep</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Madhya Pradesh") {
                                                      echo "selected";
                                                    } ?>>Madhya Pradesh</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Maharashtra") {
                                                      echo "selected";
                                                    } ?>>Maharashtra</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Manipur") {
                                                      echo "selected";
                                                    } ?>>Manipur</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Meghalaya") {
                                                      echo "selected";
                                                    } ?>>Meghalaya</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Mizoram") {
                                                      echo "selected";
                                                    } ?>>Mizoram</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Nagaland") {
                                                      echo "selected";
                                                    } ?>>Nagaland</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Orissa") {
                                                      echo "selected";
                                                    } ?>>Orissa</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Pondicherry") {
                                                      echo "selected";
                                                    } ?>>Pondicherry</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Punjab") {
                                                      echo "selected";
                                                    } ?>>Punjab</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Rajasthan") {
                                                      echo "selected";
                                                    } ?>>Rajasthan</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Sikkim") {
                                                      echo "selected";
                                                    } ?>>Sikkim</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Tamil Nadu") {
                                                      echo "selected";
                                                    } ?>>Tamil Nadu</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Tripura") {
                                                      echo "selected";
                                                    } ?>>Tripura</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Uttar Pradesh") {
                                                      echo "selected";
                                                    } ?>>Uttar Pradesh</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "Uttaranchal") {
                                                      echo "selected";
                                                    } ?>>Uttaranchal</option>
                                            <option <?php if ($balancesheet['student_profile_state'] == "West Bengal") {
                                                      echo "selected";
                                                    } ?>>West Bengal</option>
                                          </select>
                                        </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select name="reg_medium" id="reg_medium" class="custom-select">
                                            ...
                                            <option <?php if ($balancesheet['student_course_medium_study'] == "Tamil") {
                                                      echo "selected";
                                                    } ?> value="Tamil">Tamil</option>
                                            <option <?php if ($balancesheet['student_course_medium_study'] == "Samskrit") {
                                                      echo "selected";
                                                    } ?> value="Samskrit">Samskrit</option>
                                            <option <?php if ($balancesheet['student_course_medium_study'] == "English") {
                                                      echo "selected";
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select name="reg_examinationmonth" class="custom-select">
                                            ...
                                            <option <?php if ($balancesheet['student_course_month'] == "January") {
                                                      echo "selected";
                                                    } ?> value="Jan">January</option>
                                            <option <?php if ($balancesheet['student_course_month'] == "July") {
                                                      echo "selected";
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <select name="reg_preftime" class="custom-select">
                                            ...
                                            <option <?php if ($balancesheet['student_course_preferredtime'] == "Morning") {
                                                      echo "selected";
                                                    } ?> value="Morning">Morning</option>
                                            <option <?php if ($balancesheet['student_course_preferredtime'] == "Evening") {
                                                      echo "selected";
                                                    } ?> value="Evening">Evening</option>
                                            <option <?php if ($balancesheet['student_course_preferredtime'] == "Anytime") {
                                                      echo "selected";
