...
class Users extends CI_Controller {
	...
	public function index()
	{
		...
		if($this->form_validation->run()==true){
			...
			$getAllResult = $this->User_model->getAllResult1($month,$year,$course);
			$data['getAllResult']=$getAllResult;

			$getAllCourse = $this->User_model->getAllCourse();
			$data['getAllCourse'] = $getAllCourse;
			$this->load->view('admin/users',$data);

		}else{

			$getAllResult = $this->User_model->getAllResult12();
			$data['getAllResult']=$getAllResult;
	...
	public function filter()
	{
		...
		$getAllResult = $this->User_model->getAllResult($branch_id);
		echo $getAllResult;	
	}
	...
	public function update()
	{
		...
		$create = $this->User_model->update($id,$form_array);
	}
